...
class DriverFuncLib():
    ...
    def assert_elelment_visibility(self, locator, is_visible = True):
        self.logger.info(f"Asserting element visibility: {locator}")
